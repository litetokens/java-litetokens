...
public class RecommendProperties {
  ...
  public static void main(String[] args) {
    ...
    if (checkVersion) {
      System.out.println("your java version is satisfied");
    } else {
      System.out.println("your java version MUST be oracle jdk, and version >= 1.8");
    }

    long mem = getMem();
    System.out.println("recommend mem: " + mem + " MB");
