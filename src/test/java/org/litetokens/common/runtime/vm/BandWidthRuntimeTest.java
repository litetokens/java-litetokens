...
public class BandWidthRuntimeTest {
  ...
  private static String TriggerOwnerAddress = "LcjepiM3vhk27Z7uREq3GGu7tBq6qH4z19";
  private static String TriggerOwnerTwoAddress = "LeDgf3bhFNrpMpPd3XEvkVo1qBY2y7e1Lz";
  ...
  public void testSuccessNoBandd() {
    try {
      ...
      TransactionTrace trace = new TransactionTrace(xltCap, dbManager);
      dbManager.consumeBandwidth(xltCap, trace);
      long bandWidth = xltCap.getSerializedSize() + Constant.MAX_RESULT_SIZE_IN_TX;
      BlockCapsule blockCapsule = null;
      DepositImpl deposit = DepositImpl.createRoot(dbManager);
      Runtime runtime = new RuntimeImpl(trace, blockCapsule, deposit,
          new ProgramInvokeFactoryImpl());
