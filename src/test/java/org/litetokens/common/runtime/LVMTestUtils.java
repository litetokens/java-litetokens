...
public class LVMTestUtils {
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction xlt,
  ...
  public static LVMTestResult deployContractWithCreatorEnergyLimitAndReturnLVMTestResult(String contractName,
      byte[] callerAddress,
      String ABI, String code, long value, long feeLimit, long consumeUserResourcePercent,
      String libraryAddressPair, Manager dbManager, BlockCapsule blockCap, long creatorEnergyLimit)
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException, VMIllegalException {
    Transaction xlt = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(contractName, callerAddress, ABI,
