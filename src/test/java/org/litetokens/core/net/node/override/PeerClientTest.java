package org.litetokens.core.net.node.override;
...
public class PeerClientTest {
  ...
  private LitetokensChannelInitializerTest litetokensChannelInitializer;
  ...
  public PeerClientTest() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "LitetokensJClientWorker-test-" + cnt.getAndIncrement());
      }
    });
  }

  public void prepare(String remoteId) {
    litetokensChannelInitializer = ctx.getBean(LitetokensChannelInitializerTest.class, remoteId);
  ...
  public void close() {
    litetokensChannelInitializer.close();
