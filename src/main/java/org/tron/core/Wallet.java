...
public class Wallet {
  ...
  public GrpcAPI.Return broadcastTransactionForNetWorkTest(Transaction transaction) {
    p2pNode.peerConsume(peer -> peer.sendMessage(new TransactionMessage(transaction)));
