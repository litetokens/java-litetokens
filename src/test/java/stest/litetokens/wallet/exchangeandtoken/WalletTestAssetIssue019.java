package stest.litetokens.wallet.exchangeandtoken;
...
public class WalletTestAssetIssue019 {
  ...
  String url = "https://github.com/litetokens/wallet-cli/";
  ...
  @Test(enabled = true)
  public void testCanNotCreateTokenNameByXlt() {
    //get account
    ...
    Assert.assertFalse(PublicMethed.createAssetIssue(asset019Address,
        "xlt", totalSupply, 1, 1, start, end, 1, description, url,
    ...
    Assert.assertTrue(PublicMethed.createAssetIssue(asset019Address,
        "xltxlt", totalSupply, 1, 1, start, end, 1, description, url,
        2000L,2000L, 1L,1L,asset019Key,blockingStubFull));
