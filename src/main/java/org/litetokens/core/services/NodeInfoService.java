...
import org.litetokens.common.entity.NodeInfo.ConfigNodeInfo;
import org.litetokens.common.entity.NodeInfo.MachineInfo;
import org.litetokens.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.litetokens.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.litetokens.common.entity.PeerInfo;
...
import org.litetokens.core.services.WitnessProductBlockService.CheatWitnessInfo;
import org.litetokens.program.Version;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getLitetokensLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getLitetokensLastRemoteDisconnectReason();
