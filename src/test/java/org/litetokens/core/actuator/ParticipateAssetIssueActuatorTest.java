...
public class ParticipateAssetIssueActuatorTest {
  ...
  /**
   * SameTokenName close, not enough xlt
   */
  @Test
  public void sameTokenNameCloseNotEnoughXltTest() {
    initAssetIssue(dbManager.getDynamicPropertiesStore().getLatestBlockHeaderTimestamp() - 1000,
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderTimestamp() + 1000);
  ...
  /**
   * SameTokenName open, not enough xlt
   */
  @Test
  public void sameTokenNameOpenNotEnoughXltTest() {
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(1);
    initAssetIssue(dbManager.getDynamicPropertiesStore().getLatestBlockHeaderTimestamp() - 1000,
            dbManager.getDynamicPropertiesStore().getLatestBlockHeaderTimestamp() + 1000);
    // First, reduce the owner xlt balance. Else can't complete this test case.
  ...
  /**
   * SameTokenName close, exchangeAmount <= 0 xlt, throw exception
   */
  @Test
  ...
  /**
   * SameTokenName open, exchangeAmount <= 0 xlt, throw exception
   */
  @Test
