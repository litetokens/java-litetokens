...
public class UnfreezeBalanceActuatorTest {
  ...
  private Any getContractForCpu(String ownerAddress) {
    return Any.pack(
        Contract.UnfreezeBalanceContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(ownerAddress)))
            .setResource(org.litetokens.protos.Contract.ResourceCode.ENERGY)
            .build());
  }
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getLitePower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getLitePower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getLitePower());
    ...
    Assert.assertEquals(0L, receiver.getLitePower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getLitePower());
