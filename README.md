...
This is similar to running a private testnet, except that the IPs in the `config.conf` are officially declared by LITETOKENS.
...
20:39:40.010 INFO [o.t.c.d.Manager] postponedXltCount[0],XltLeft[0]
