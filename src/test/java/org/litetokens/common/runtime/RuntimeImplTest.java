...
import static org.litetokens.common.runtime.LVMTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.litetokens.common.runtime.LVMTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveTotalEnergyWeight(5_000_000_000L); // unit is xlt
  ...
  public void getCreatorEnergyLimit2Test() {
    ...
    Transaction xlt = generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);

    RuntimeImpl runtimeImpl = new RuntimeImpl(xlt, null, deposit, new ProgramInvokeFactoryImpl(),
        true);
  ...
  public void getCallerAndCreatorEnergyLimit2With0PercentTest()
    ...
    LVMTestResult result = LVMTestUtils
        .deployContractWithCreatorEnergyLimitAndReturnLVMTestResult(contractName, creatorAddress,
            ABI, code, value,
