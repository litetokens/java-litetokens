...
public class LitetokensDice {
  ...
  public void litetokensDice() {
    ECKey ecKey1 = new ECKey(Utils.getRandom());
    byte[] litetokensDiceAddress = ecKey1.getAddress();
    String litetokensDiceKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    PublicMethed.sendcoin(litetokensDiceAddress,100000000000L,fromAddress,testKey002,blockingStubFull);
    String contractName = "LitetokensDice";
    ...
    byte[] contractAddress = PublicMethed.deployContract(contractName,abi,code,"",
        maxFeeLimit,1000000000L, 100,null,litetokensDiceKey,litetokensDiceAddress,blockingStubFull);
    ...
    for (Integer i = 0; i < 100; i++) {
      ...
      txid = PublicMethed.triggerContract(contractAddress,
          ...
          1000000, maxFeeLimit, litetokensDiceAddress, litetokensDiceKey, blockingStubFull);
      logger.info(txid);
      txidList.add(txid);
