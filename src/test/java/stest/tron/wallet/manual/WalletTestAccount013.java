...
public class WalletTestAccount013 {
  ...
  public void getAllowDelegateResource() {
    ...
    Assert.assertTrue(PublicMethed.sendcoin(account013Address,100000000L,fromAddress,testKey002,blockingStubFull));
    Assert.assertTrue(PublicMethed.sendcoin(receiverDelegateAddress,100000000L,fromAddress,testKey002,blockingStubFull));
    AccountResourceMessage account013Resource = PublicMethed.getAccountResource(account013Address, blockingStubFull);
    ...
    AccountResourceMessage receiverResource = PublicMethed.getAccountResource(receiverDelegateAddress, blockingStubFull);
