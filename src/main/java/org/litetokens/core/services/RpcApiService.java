...
import org.litetokens.protos.Contract.UpdateEnergyLimitContract;
...
import org.litetokens.protos.Protocol.NodeInfo;
...
public class RpcApiService implements Service {
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getLitePower() < votesCount,
          "lite power[" + account.getLitePower() + "] <  VotesCount[" + votesCount + "]");
