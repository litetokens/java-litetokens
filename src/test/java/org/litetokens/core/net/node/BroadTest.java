...
import org.litetokens.core.net.node.override.HandshakeHandlerTest;
import org.litetokens.core.net.node.override.PeerClientTest;
import org.litetokens.core.net.node.override.LitetokensChannelInitializerTest;
...
public class BroadTest {
  ...
  private void removeTheTxAndBlock(Sha256Hash blockId, Sha256Hash transactionId) {
    Cache<Sha256Hash, TransactionMessage> xltCache = ReflectUtils
        .getFieldValue(nodeImpl, "XltCache");
...
//        appT.startup();
  ...
  private void prepare() {
    try {
      ...
      LitetokensChannelInitializerTest litetokensChannelInitializer = ReflectUtils
          .getFieldValue(peerClient, "litetokensChannelInitializer");
      litetokensChannelInitializer.prepare();
      Channel channel = ReflectUtils.getFieldValue(litetokensChannelInitializer, "channel");
