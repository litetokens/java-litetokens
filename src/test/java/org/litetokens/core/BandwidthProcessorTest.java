...
//    Assert.assertEquals(101220L, ret.getFee());
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = xlt.getInstance().toBuilder().clearRet().build().getSerializedSize() +
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule xlt = new TransactionCapsule(contract, dbManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(xlt, dbManager);
