...
public class WalletTestAccount013 {
  ...
  public void test3DelegateResourceAboutTransferAsset() {
    ...
    long account013CurrentBandwidth = PublicMethed.getAccountResource(
    ...
    long account5CurrentBandwidth = PublicMethed.getAccountResource(
    ...
    long account013CurrentBandwidthAfterTrans = PublicMethed.getAccountResource(
            account013Address, blockingStubFull).getNetUsed();
    long accountForAssetIssueCurrentBandwidthAfterTrans = PublicMethed.getAccountResource(
            accountForAssetIssueAddress, blockingStubFull).getFreeNetUsed();
    long account5CurrentBandwidthAfterTrans = PublicMethed.getAccountResource(
            account5DelegatedResourceAddress, blockingStubFull).getNetUsed();
...
//        result += account5FreeAssetBandwidthAfterTrans.getAssetNetLimitMap().get(name1);
//        result += "\n";
//        result += "}";
//        result += "\n";
      }
